...
%% KoNViD-1k
data_path = 'E:/Projects/VQA/DataBase/KoNViD-1k/KoNViD_1k_metadata/KoNViD_1k_attributes.csv';
data = readtable(data_path);
video_names = data.flickr_id + '.mp4'; % video names
...
%% CVD2014
data_path = 'E:/项目/VQA/数据集/CVD2014/CVD2014_ratings/Realignment_MOS.csv';
data = readtable(data_path);
